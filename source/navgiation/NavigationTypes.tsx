export type RootStackParamList = {
  ...
  AddResistanceExercise: {firstVisit: boolean};
  AddResistanceExerciseSets: {exerciseId: string; formIndex: number};
  ResistanceSetsSummary: undefined;
  AddCardioExercise: {firstVisit: boolean};
  AddCardioExerciseSets: {exerciseId: string; formIndex: number};
  CardioSetsSummary: undefined;
