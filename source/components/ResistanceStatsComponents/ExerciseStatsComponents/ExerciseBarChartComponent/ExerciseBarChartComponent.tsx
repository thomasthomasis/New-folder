...
type ResistanceExerciseBarChartComponentProps = {
  data:any,
  exerciseId:string,
};

export const ExerciseBarChartComponent = (props: ResistanceExerciseBarChartComponentProps) => {
  ...
  const getTotalVolumeAndReps = (data:any) => {
    ...
    for(let i = 0; i < data.length; i++)
    {
        ...
        for(let j = 0; j < data[i].weights.length; j++)
        {
            ...
            let exercisesArray = data[i].exercises.map(JSON.parse);
            ...
            let weightArray = JSON.parse(data[i].weights[j])
            let repsArray = JSON.parse(data[i].reps[j])
    ...
    return (
        ...
        }
        {
            ...
            <View style={styles.mainContainer}>
              <View style={styles.container}>
                <Text style={{fontSize: 15, fontWeight: '700', color: colors.text, marginBottom: 10,}}>Total Volume</Text>
              ...
              <View style={styles.container}>
              <Text style={{fontSize: 15, fontWeight: '700', color: colors.text, marginBottom: 10,}}>Total Reps</Text>
