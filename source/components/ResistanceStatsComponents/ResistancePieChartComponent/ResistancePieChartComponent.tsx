...
export const ResistancePieChartComponent = (props: ResistancePieChartComponentProps) => {
  ...
  const limitString = (str:string, maxLength:number, useEllipsis:boolean) => {
    ...
    <>
        ...
        <Text style={{fontSize: 14, fontWeight: '500', color: colors.text, marginBottom: 10,}}>Volume Distribution</Text>
        <PieChart
        ...
        <View style={styles.container}>
        <Text style={{fontSize: 14, fontWeight: '500', color: colors.text, marginBottom: 10,}}>Reps Distribution</Text>
        <PieChart
          data={graphTotalReps}
          donut
          showGradient
