    ...
    <View>
      ...
      <View style={styles.weekdays}>
        <View style={styles.weekday}>
          <Text style={{color: colors.green}}>M</Text>
        </View>
        <View style={styles.weekday}>
          <Text style={{color: colors.green}}>T</Text>
        </View>
        <View style={styles.weekday}>
          <Text style={{color: colors.green}}>W</Text>
        </View>
        <View style={styles.weekday}>
          <Text style={{color: colors.green}}>T</Text>
        </View>
        <View style={styles.weekday}>
          <Text style={{color: colors.green}}>F</Text>
        </View>
        <View style={styles.weekday}>
      ...
      <View style={styles.container}>
        {calendarDays.map((day, index) => (
          <TouchableOpacity
            ...
            onPress={() => {
              props.selectDay(day.toString(), month, year), selectDay(day.toString());
            }}>
