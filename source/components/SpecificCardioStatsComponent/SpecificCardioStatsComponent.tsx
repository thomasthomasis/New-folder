  ...
  return (
    <View style={styles.container}>
      ...
      {props.data.map((item: any) => {
        return <StatsLayout key={item._id} dateCreated={item.dateCreated} exercise={item.exercise} time={item.time} distance={item.distance} extraNotes={item.extraNotes} timeline={props.timeline} id={item._id.toString()} />;
      })}
    </View>
  );
};
