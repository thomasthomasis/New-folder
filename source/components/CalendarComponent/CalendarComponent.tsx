...
export const CalendarComponent = (props: CalendarProps) => {
    ...
    return (
      <>
        <View style={[styles.mainContainer, shadow.shadow]}>
            <View style={[styles.arrows, common.conatinerInnerPadding]}>
              ...
              <Text style={[styles.month, common.h2, {marginRight: 10,}]}>{monthWord} {year}</Text>
            ...
            <View style={[styles.weekdays, common.containerOuterPadding]}>
              <View style={styles.weekday}><Text style={[{color: colors.text}, common.h2]}>M</Text></View>
              <View style={styles.weekday}><Text style={[{color: colors.text}, common.h2]}>T</Text></View>
              <View style={styles.weekday}><Text style={[{color: colors.text}, common.h2]}>W</Text></View>
              <View style={styles.weekday}><Text style={[{color: colors.text}, common.h2]}>T</Text></View>
              <View style={styles.weekday}><Text style={[{color: colors.text}, common.h2]}>F</Text></View>
              <View style={styles.weekday}><Text style={[{color: colors.text}, common.h2]}>S</Text></View>
              <View style={styles.weekday}><Text style={[{color: colors.text}, common.h2]}>S</Text></View>
            </View>
        <View style={[styles.container, common.containerOuterPadding]}>
            ...
            onPress={() => selectDay(day.toString())}>
      ...
      <View style={styles.containerModal}> 
        ...
        <View style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', marginBottom: 24, }}>
