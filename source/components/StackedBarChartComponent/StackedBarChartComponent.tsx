    ...
    return (
      <View style={[styles.container, shadow.shadow]}>
        ...
        }
        {
          props.data &&
          <>
          <View style={{position: 'absolute', top: 0, width: screenWidth - 25, display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
            ...
            <View style={{display: 'flex', padding: 10, width: '100%'}}>
              ...
              {data.map((item:any, index:any) => (            
                <View key={index} style={{ width: '80%', height: (item.workouts / totalWorkouts) * 180, backgroundColor: item.color, display: 'flex', justifyContent: 'center', alignItems: 'center' }} >
            ...
            <View style={styles.legend}>
              {
                data.map((item:any, index:any) => (
                  ...
                  {
                    item.workouts > 0 &&
                    <View style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 10, marginRight: 10,}}>
                      <View style={{width: 10, height: 10, borderRadius: 15, backgroundColor: item.color, marginRight: 5, }}></View>
