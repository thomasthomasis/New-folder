...
import styles from './GeneralLineChartComponent.style';


type GeneralLineChartComponentProps = {
  data:any,
  startDate:Date,
  endDate:Date,
  filter:number,
...
export const GeneralLineChartComponent = (props: GeneralLineChartComponentProps) => {
  ...
  const convertFilterToText = (filter:number) => {
    ...
    return (
      <View style={styles.container}>
        <Text style={{marginBottom: 10, fontWeight: '800', color: colors.black, fontSize: 18,}}>Average Workout Frequency</Text>
