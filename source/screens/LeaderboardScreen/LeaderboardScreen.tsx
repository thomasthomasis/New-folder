                ...
                <View style={styles.containerPodium}>
                    
                    {
                        ...
                        <View style={styles.podiumContent}>
                            ...
                            <LinearGradient colors={['#95741f', '#e6cb84']} style={[styles.podium, {height: 100, borderTopLeftRadius: 10, borderWidth: 1, borderColor: 'black',}]}><Text style={styles.podiumText}>3</Text></LinearGradient>
                        </View>
                    }
                    <View style={styles.podiumContent}>
                        ...
                        <LinearGradient colors={['#ccb825', '#eadf8c']} style={[styles.podium, shadow.shadow, { position: 'relative', zIndex: 2, borderTopRightRadius: 10, borderTopLeftRadius: 10, borderWidth: 1, borderColor: 'black'}]}><Text style={styles.podiumText}>1</Text></LinearGradient>
                    </View>
                    {
                        users.length > 1 &&
                        <View style={styles.podiumContent}>
                            ...
                            <LinearGradient colors={['#6f726e', '#dbdcdb']} style={[styles.podium, shadow.shadow, {height: 140, borderTopRightRadius: 10, borderWidth: 1, borderColor: 'black'}]}><Text style={styles.podiumText}>2</Text></LinearGradient>
                        </View>
                    }
                    ...
                    <View style={[styles.containerLeaderBoard, shadow.shadow, {position: 'relative', zIndex: 3, borderWidth: 1, borderColor: 'black'}]}>
