...
export const CardioExerciseStatsScreen = ({ navigation, route }: CardioExerciseStatsScreenProps) => {
    ...
    const getHighestDistanceAndTimeInterval = (data:any) => {
                    ...
                    <View style={{minHeight: screenHeight * 2}}>
                        ...
                        <View style={styles.container}>
                            ...
                            <TouchableOpacity style={[styles.card, shadow.shadow]} onPress={() => goToWorkoutView(highestDistanceAndTimeInterval.workoutIdDistance)}>
                                <Text style={{fontSize: 20, fontWeight: '500', color: colors.text,}}>Longest Distance Interval</Text>
                                <Text style={{fontSize: 40, fontWeight: '900', color: colors.text}}>{highestDistanceAndTimeInterval.largestDistance}KM</Text>
                                <Text style={{fontSize: 15, fontWeight: '400', color: colors.text}}>{highestDistanceAndTimeInterval.dateDistance.toDateString()}</Text>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity style={[styles.card, shadow.shadow]} onPress={() => goToWorkoutView(highestDistanceAndTimeInterval.workoutIdTime)}>
                                ...
                                <Text style={{fontSize: 40, fontWeight: '900', color: colors.text}}>{highestDistanceAndTimeInterval.largestTime} Min</Text>
                                <Text style={{fontSize: 15, fontWeight: '400', color: colors.text}}>{highestDistanceAndTimeInterval.dateTime.toDateString()}</Text>
                            </TouchableOpacity>
                        </View>
