    ...
    return (
        ...
        <ScrollView contentContainerStyle={styles.container}>
            <View style={[styles.containerOption, shadow.shadow]}>
                ...
                <TouchableOpacity style={[{width: '90%', height: 40, backgroundColor: colors.green, display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: 5}, shadow.shadow]}>
