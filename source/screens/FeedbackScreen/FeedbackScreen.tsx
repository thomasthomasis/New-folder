...
export const FeedbackScreen = ({navigation}: FeedbackScreenProps) => {
  ...
  useEffect(() => {
    realm.subscriptions.update(mutableSubs => {
      mutableSubs.add(realm.objects(Feedback));
    });
  }, [realm, user]);
  ...
  return (
    <Pressable style={styles.container} onPress={Keyboard.dismiss}>
      ...
      <View>
        ...
        <TextInput style={[styles.textInput]} multiline={true} numberOfLines={20} value={commentText} onChangeText={setCommentText} placeholder="If you have any input at all, please type it here..." />
      </View>
    </Pressable>
  );
};
