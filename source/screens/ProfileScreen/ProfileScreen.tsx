...
export const ProfileScreen = ({navigation, route}: ProfileScreenProps) => {
  ...
  return (
    <>
            ...
            <View
              ...
              <View
                ...
                <Text style={styles.name}>
                  {userData[0].firstName as string} {userData[0].lastName as string}
                </Text>
          ...
          <View style={styles.container}>
            ...
            <FlatList
              ...
              renderItem={({item, index}) => (
                <TouchableOpacity
                  key={index}
                  style={[styles.groupButton, shadow.shadow, {marginTop: 15}, item.color != null && {backgroundColor: item.color}]}
                  onPress={() => {
                  ...
                  <View
                    ...
                    {item.image && <MaterialCommunityIcons name={item.image} color={'black'} size={45} />}
                    <View
                      style={{
                        display: 'flex',
                        flexDirection: 'row',
      ...
      <Modal isVisible={showingModalStatus} swipeDirection={['down']} onSwipeComplete={onClose} onBackdropPress={onClose} style={styles.modalView}>
        <View style={styles.modalContent}>
          <Text style={[styles.buttonText, {marginBottom: 15}]}>Change Current Status</Text>
          <TouchableOpacity
            onPress={() => {
              onClose();
              setNewStatus(userId, 'Healthy');
            }}
            style={[
              styles.button,
              shadow.shadow,
