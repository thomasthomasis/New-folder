...
export const LogWorkoutCardioScreen = ({navigation, route}: LogWorkoutCardioProps) => {
  ...
  const handleAddInput = (formIndex: any) => {
    ...
    const newTimeInput = {
      id: forms[formIndex].timeInputs.length + 1,
      value: '',
    };
    const newDistanceInput = {
      id: forms[formIndex].distanceInputs.length + 1,
      value: '',
    };
  ...
  return (
    <>
            ...
            {forms.map((form: any, formIndex: any) => (
              <View key={new BSON.ObjectID().toString()} style={styles.form}>
                    ...
                    <View style={styles.inputs}>
                      <View style={styles.inputBoxes}>
                        <View style={styles.inputContainer}>
                          ...
                          <TextInput placeholder="" value={form.timeInputs[inputIndex].value} onChangeText={text => handleTimeInputChange(text, formIndex, inputIndex)} style={styles.input} keyboardType="numeric" />
                        </View>
                        ...
                        <View style={styles.inputContainer}>
                          ...
                          {inputIndex > 0 && <Text></Text>}
                          <TextInput placeholder="" value={form.distanceInputs[inputIndex].value} onChangeText={text => handleDistanceInputChange(text, formIndex, inputIndex)} style={styles.input} keyboardType="numeric" />
                        </View>
                      </View>
                    </View>
                ...
                <View style={styles.textareaContainer}>
                  ...
                  <TextInput value={form.extraNotes.value} onChangeText={text => handleExtraNotesInputChange(text, formIndex)} style={styles.textarea} multiline={true} numberOfLines={20} placeholder="" keyboardType="default" />
                </View>
      ...
      <Modal isVisible={visible} swipeDirection={['down']} onSwipeComplete={onClose} onBackdropPress={onClose} style={styles.modalView}>
