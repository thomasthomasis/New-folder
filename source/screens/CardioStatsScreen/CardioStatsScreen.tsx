...
export const CardioStatsScreen = ({navigation, route}: CardioStatsScreenProps) => {
  ...
  const goToExerciseStats = (exerciseId: string) => {
    navigation.navigate('CardioExerciseStats', {
      userId: userId,
                ...
                <View style={styles.container}>
                  ...
                  <TouchableOpacity style={[styles.card, shadow.shadow]} onPress={() => goToWorkoutView(highestDistanceSession.workoutId)}>
                    ...
                    <Text
                      ...
                      {highestDistanceSession.highestDistance}KM
                    </Text>
                    <Text
                      style={{
                        fontSize: 15,
                      ...
                      {highestDistanceSession.date.toDateString()}
                    </Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity style={[styles.card, shadow.shadow]} onPress={() => goToWorkoutView(highestTimeSession.workoutId)}>
                    ...
                    <Text
                      ...
                      {highestTimeSession.largestTime} Minutes
                    </Text>
                    <Text
                      style={{
                        fontSize: 15,
                      ...
                      {highestTimeSession.date.toDateString()}
                    </Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity style={[styles.card, shadow.shadow]} onPress={() => goToWorkoutView(highestTimeAndDistanceSet.workoutIdDistance)}>
                    ...
                    <Text
                      ...
                      {highestTimeAndDistanceSet.largestDistance}KM
                    </Text>
                    <Text
                      style={{
                        fontSize: 17,
                      ...
                      {getExerciseName(highestTimeAndDistanceSet.exerciseIdDistance)}
                    </Text>
                    <Text
                      style={{
                        fontSize: 15,
                      ...
                      {highestTimeAndDistanceSet.dateDistance.toDateString()}
                    </Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity style={[styles.card, shadow.shadow]} onPress={() => goToWorkoutView(highestTimeAndDistanceSet.workoutIdTime)}>
                    ...
                    <Text
                      ...
                      {highestTimeAndDistanceSet.largestTime} Minutes
                    </Text>
                    <Text
                      style={{
                        fontSize: 17,
                      ...
                      {getExerciseName(highestTimeAndDistanceSet.exerciseIdTime)}
                    </Text>
                    <Text
                      style={{
                        fontSize: 15,
                      ...
                      {highestTimeAndDistanceSet.dateTime.toDateString()}
                    </Text>
                  </TouchableOpacity>
