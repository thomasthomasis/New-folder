...
type ResistanceStatsScreenProps = {
  navigation: StackNavigationProp<RootStackParamList, 'ResistanceExerciseStats'>; // Adjust according to your navigation stack
  route: RouteProp<RootStackParamList, 'ResistanceExerciseStats'>;
};
...
export const ResistanceExerciseStatsScreen = ({ navigation, route }: ResistanceStatsScreenProps) => {
    ...
    useEffect(() => {
        ...
        let relevantResistanceWorkouts = getExerciseRelevantWorkouts(resistanceWorkouts);

        setWorkoutData(relevantResistanceWorkouts)

        console.log("Relevant Workouts: ", relevantResistanceWorkouts)
        ...
        }
        {
            ...
            <View style={{width: '100%', height: 60, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: colors.black}}>
                    <View style={styles.headerTitle}>
                        ...
                        <Text style={{fontSize: 20, fontWeight: '800', marginLeft: 20, color: 'white'}}>{getExerciseName(exerciseId)} Stats</Text>
                    </View>
                </View>
                <ScrollView>
                    ...
                    <View style={{minHeight: screenHeight * 2}}>
                        ...
                        <View style={styles.container}>
                            ...
                            <TouchableOpacity style={[styles.card, shadow.shadow]} onPress={() => goToWorkoutView(highestVolumeAndRepSet.workoutIdReps)}>
                                ...
                                <Text style={{fontSize: 40, fontWeight: '900', color: colors.text}}>{highestVolumeAndRepSet.largestReps}</Text>
