...
export const EditCardioExerciseScreen = ({ navigation, route}: EditCardioExerciseScreenProps) => {
      ...
      const handleConfirm = () => {
        ...
        Alert.alert(
          ...
          [
            ...
            {
              text: 'OK',
              onPress: () => {editExercise(exerciseName); goBack()},
            },
          ],
          { cancelable: false }
        );
  ...
  return (
    <>
        <View style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', width: '100%', paddingTop: 10, paddingBottom: 10, backgroundColor: colors.red, marginBottom: 10,}}>
