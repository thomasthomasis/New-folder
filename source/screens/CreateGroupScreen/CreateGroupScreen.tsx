        ...
        <ScrollView contentContainerStyle={styles.scrollView}>
            ...
            <View style={[styles.container, shadow.shadow]}>
                <TouchableOpacity style={[styles.conatinerImage, shadow.shadow]}>
                    {
                        image &&
                        <TouchableOpacity onPress={() => setImageModalVisible(true)} style={{backgroundColor: selectedColor, width: 100, height: 100, borderRadius: 100, display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                ...
                <View style={styles.containerInput}>
                    ...
                    <TextInput
                        value={groupSport}
                        onChangeText={text => setGroupSport(text)}
                        placeholder="Enter group sport"
                        style={styles.input}
                    />
                </View>
                <View style={styles.containerInput}>
